...
public sealed class MainViewModel : ObservableObject
{
    ...
    public async Task SetReadingTypographyAsync(string fontFamily, int fontSize, int titleFontSize)
    {
    ...
    {
        await _storageService.SaveBackupAsync(path, CreateState(includeArticles: false, includeFeedlyToken: false));
    }
    ...
    private void ToggleTextToSpeech()
    {
        ...
        try
        {
            ...
            {
                _textToSpeechService.Speak(SelectedArticle.Title, SelectedArticle.HtmlContent, TextToSpeechVolume);
            }
